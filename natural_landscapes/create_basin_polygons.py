...
DEM_paths = [file_path+'massif_central/input_data/']#[file_path+'dems_to_process/peru/input_data/', file_path+'dems_to_process/argentina/input_data/', file_path+'dems_to_process/turkey/input_data/',file_path+'dems_to_process/xian/input_data/', file_path+'dems_to_process/colorado/input_data/', file_path+'dems_to_process/alburz_south/input_data/',file_path+'dems_to_process/pyrenees/input_data/', file_path+'dems_to_process/massif_central/input_data/']# complete the list later - first try with just two cases
...
for mountain in mountain_range_names:
    print(f'I am vectorrrizing {mountain} data')
    polygon_dict = PolygoniseRaster(DEM_paths[counter], f'{mountain}_dem_AllBasins.bil', OutputShapefile='polygons')
